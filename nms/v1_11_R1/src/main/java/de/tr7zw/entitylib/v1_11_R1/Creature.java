package de.tr7zw.entitylib.v1_11_R1;
...
public class Creature extends EntityCreature implements CCreature, IMonster{
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        try {
            if(s != null){
                Class<? extends CustomCreature> wc = (Class<? extends CustomCreature>) Class.forName(s);
                if(wc != null){
                    Constructor<? extends CustomCreature> c = null;
                    try{
